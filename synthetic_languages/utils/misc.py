...
def repo_path_to_abs_path(path: str) -> Path:
    ...
    # NOTE that __file__ in python is the __file__ form which this was invoked/imported, so
    # if we are running this from a certain location, it may not be the same as THIS file's
    # location.
