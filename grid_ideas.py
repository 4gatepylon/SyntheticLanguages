...
if __name__ == "__main__":
    ...
    Path("./z1r-test-500B").mkdir(
        exist_ok=False
    )  # NOTE THIS IS COPIED FROM experiments/
    ...
    parameters = [
        [
            {"prob_of_zero_from_r_state": 0.1},
            {"prob_of_zero_from_r_state": 0.3},
            {"prob_of_zero_from_r_state": 0.5},
            {"prob_of_zero_from_r_state": 0.7},
            {"prob_of_zero_from_r_state": 0.9},
        ],
        [
            {"pR1": 0.2, "pR2": 0.5},
            {"pR1": 0.5, "pR2": 0.5},
    ...
    optimizer_config = OptimizerConfig(
        optimizer_type="adam", learning_rate=1e-2, weight_decay=weight_decay
    )
